...
#    random_val = rand(6)
    random_val = 0
    pkmn_happiness = first_pkmn.happiness
    if pkmn_happiness <= 99
      random_val = [1,2,5].sample
    elsif pkmn_happiness >= 100 && pkmn_happiness <= 199
      random_val = [0,1,2,3,5].sample
    elsif pkmn_happiness >= 200
      random_val = [0,1,2,3,4,5].sample
    end
