...
# Changes the postion of the Pokémon in the Entry Page    
    ...
    if $game_switches[Settings::DEX_ADVANCE]
      @sprites["areaoverlay"].setBitmap("Graphics/Pictures/Pokedex/overlay_area")
    else
      @sprites["areaoverlay"].setBitmap("Graphics/Pictures/Pokedex/overlay_area_1")
    end
  ...
  # top of it
    ...
    if $game_switches[Settings::DEX_ADVANCE]
      ...
      @sprites["infoverlay"].setBitmap(_INTL("Graphics/Pictures/Pokedex/info_overlay_1"))
    end
    overlay = @sprites["overlay"].bitmap
...
#      if System.user_language[3..4] == "US"   # If the user is in the United States
      if $PokemonSystem.measurements==1
...
#      if System.user_language[3..4] == "US"   # If the user is in the United States
  ...
  def drawPageForms
    ...
    if $game_switches[Settings::DEX_ADVANCE]
      ...
      @sprites["infoverlay"].setBitmap(_INTL("Graphics/Pictures/Pokedex/forms_overlay_1"))
    end
    overlay = @sprites["overlay"].bitmap
# Changes the color of the text, to the one used in BW
    base   = Color.new(255,255,255)
