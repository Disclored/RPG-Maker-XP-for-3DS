...
# Name of file in Audio/ME that plays when a quest is activated
QUEST_JINGLE = "Mission_Start.ogg"

# Name of file in Audio/ME that plays when a quest is advanced to new stage/completed
QUEST_CLEAR = "Mission_Clear.ogg"

# Name of file in Audio/SE that plays when a quest is failed
QUEST_FAIL = "Mission_Fail.ogg"

# Fade Settings
FADE_SPEED = 1
FADE_AMOUNT = (255 / FADE_SPEED).ceil
