def pbChooseRandomPokemon(whiteList=nil, blackList="suggested", addList=nil,
  ...
  elsif blackList == "hard"
    blackList = [:F00,:MT,:MT2,:HUMANOID]
  end
